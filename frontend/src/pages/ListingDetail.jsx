      ...
      <div className="grid gap-4 md:grid-cols-[minmax(0,2fr)_minmax(0,1.3fr)]">
        <div className="space-y-4 rounded-2xl border border-gray-100 bg-white shadow-sm p-4">
          ...
          <p className="mt-2 text-[11px] text-gray-500">
            Buyers can contact the farmer directly after logging in.
          </p>
        </div>
        ...
        <div className="space-y-4 rounded-2xl border border-gray-100 bg-white shadow-sm p-4">
          ...
          <div className="mt-3 space-y-1 text-xs text-gray-700">
            {canSeePhone ? (
              ...
              <div className="rounded-lg border border-amber-100 bg-amber-50 p-3 text-amber-800">
                ...
                <p className="mt-1">Log in to see the farmer phone number.</p>
                <Link to="/login" className="mt-2 inline-flex font-semibold text-amber-900 underline">
                  Log in
                </Link>
              </div>
            )}
          ...
          {Array.isArray(listing.images) && listing.images.length > 0 ? (
            ...
            <p className="mt-4 text-[11px] text-gray-400">
              No photos attached. Listings with clear photos can receive a quality badge.
            </p>
          )}
